...
<nav id="main-nav" class="clearfix">
    <div class="container clearfix">
        <ul class="root">
            ...
            <li  class="current_page_item current-menu-item" ><a title="" href="<?php echo U('Contact/index');?>?lang=zh-cn">联系我们</a></li>
         ...
         <div class="contact">
         	...
         	<div class="contact_box">
                ...
                <div class="contact_img">
                	<ul>
            		<li>
                		电话：<?php echo ($telephone["content"]); ?>
                	</li>
                	<li>
                		传真：<?php echo ($fax["content"]); ?>
                	</li>
                	<li>
                		<a href="<?php echo ($email["content"]); ?>">邮箱：<?php echo ($email["content"]); ?></a>
                	</li>
                    <li>
                		网站：<?php echo ($website["content"]); ?>
                	</li>
                    <li>
                		办公室：<?php echo ($office["content"]); ?>
                	</li>
                    <li>
                		深圳工厂：<?php echo ($factory_shenzhen["content"]); ?>
                	</li>
                    <li>
                		惠州工厂：<?php echo ($factory_huizhou["content"]); ?>
                	</li>
            	</ul>   
                ...
                <form enctype="multipart/form-data" class="form-signin" role="form" action="<?php echo U('Contact/add_contact');?>" method='post' id="form">
                <div class="contact_data">
                    <font>发件人</font>
                    <div class="contact_input">
                    	<input name="name" tyle="text">
                    </div>
                    <font>e-mail</font>
                    <div class="contact_input">
                    	<input name="email" tyle="text">
                    </div>
                    <font>公司</font>
                    <div class="contact_input">
                    	<input name="company" tyle="text">
                    </div>
                    <font>电话</font>
                    <div class="contact_input">
                    	<input name="telephone" tyle="text">
                    </div>
                    <font>内容</font>
                    <div class="contact_input">
                    	<textarea name="content" ></textarea>
                    </div>
                    <div class="contact_btn_box" align="center">
                    	<input type="submit" value="提交" style="width:160px;" class="btn btn-bottom" />
                    </div>
                </div>
                </form>
             </div><!--contact_box-->
