...
<div id="main">
    <div class="container">
                    ...
                    <div class="box">
                        <div class="picbox">
                            <ul class="piclist mainlist">
                                <?php if(is_array($soft)): $i = 0; $__LIST__ = array_slice($soft,0,12,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="#" target="_blank"><img src="/ucreate-pcb-co<?php echo ($data["pic_adr"]); ?>"/></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
        ...
        <?php if(is_array($soft)): $i = 0; $__LIST__ = $soft;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="pro_box">
                <div class="pro_img">
