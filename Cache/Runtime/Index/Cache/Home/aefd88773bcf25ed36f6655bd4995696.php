    ...
    <nav>
      <div class="container1">
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="row">
              <div class="col-md-2 sign">男士服装</div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <a href="#">
                <div class="col-md-3">
                  <div class="thumbnail framework" style="border:none;padding:0px;">
                    <img src="/taobaoke/Public/Index/img/pic6.png" style="width:100%">
                    <div class="caption">
                      <p>Vinel 高端时尚女装</p>
                    </div>
                  </div>
              ...
              <a href="#">
                <div class="col-md-3">
                  <div class="thumbnail framework" style="border:none;padding:0px;">
                    <img src="/taobaoke/Public/Index/img/pic7.png" >
                    <div class="caption">
                      <p>缔非服装</p>
                    </div>
                  </div>
              ...
              <a href="#">
                <div class="col-md-3">
                  <div class="thumbnail framework" style="border:none;padding:0px;">
                    <img src="/taobaoke/Public/Index/img/pic8.png">
                    <div class="caption">
                      <p>Topbuyer - 时髦实穿</p>
                    </div>
                  </div>
              ...
              <a href="#">
                <div class="col-md-3">
                  <div class="thumbnail framework" style="border:none;padding:0px;">
                    <img src="/taobaoke/Public/Index/img/pic6.png" >
                    <div class="caption">
                      <p>Vinel 高端时尚女装</p>
                    </div>
                  </div>
