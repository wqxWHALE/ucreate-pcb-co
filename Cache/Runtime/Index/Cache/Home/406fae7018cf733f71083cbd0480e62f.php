...
function checkEmail()
 {
  ...
  {
   alert("E－mail format error, please input again!");
...
function checkNull(str){
    var name = document.getElementById(str).value.replace(/[]/g,"");//把所有空格去掉
    if(name.length==0){
        return false;
    }
    return true;
 ...
 <nav id="main-nav" class="clearfix">
    <div class="container clearfix">
        <ul class="root">
            ...
            <li class="current_page_item current-menu-item" ><a title="" href="<?php echo U('Contact/index');?>">Contact us</a></li>
         ...
         <div class="contact">
         	...
         	<div class="contact_box">
                ...
                <div class="contact_img">
                	<ul>
            		<li>
                		Tel：<?php echo ($telephone["content"]); ?>
                	</li>
                	<li>
                		Fax：<?php echo ($fax["content"]); ?>
                	</li>
                	<li>
                		<a href="<?php echo ($email["content"]); ?>">E-mail：<?php echo ($email["content"]); ?></a>
                	</li>
                    <li>
                		website：<?php echo ($website["content"]); ?>
                	</li>
                    <li>
                		Office：<?php echo ($office["content"]); ?>
                	</li>
                    <li>
                		Shenzhen Factory：<?php echo ($factory_shenzhen["content"]); ?>
                	</li>
                    <li>
                		Huizhou Factory：<?php echo ($factory_huizhou["content"]); ?>
                	</li>
            	</ul>   
                    
                
                <div class="map_box"style="width:450px;height:350px;border:#ccc solid 1px;" id="dituContent01"></div>
                </div>
                <form enctype="multipart/form-data" class="form-signin" role="form" action="<?php echo U('Contact/add_contact_en');?>" method='post' id="form">
                <div class="contact_data">
                    <font>Name:</font>
                    <div class="contact_input">
                    	<input id="name" name="name" tyle="text">
                    </div>
                    <font>E-mail:</font>
                    <div class="contact_input">
                    	<input id="email" name="email" tyle="text">
                    </div>
                    <font>Company Name:</font>
                    <div class="contact_input">
                    	<input id="company_name" name="company_name" tyle="text">
                    </div>
                    <font>Telephone:</font>
                    <div class="contact_input">
                    	<input id="telephone" name="telephone" tyle="text">
                    </div>
                    <font>Comments:</font>
                    <div class="contact_input">
                    ...
                    <div class="contact_btn_box">
                        <a href="#" class="btn btn-bottom" onclick="checkEmail()">提交</a>
                    </div>
                </div>
                </form>
             </div><!--contact_box-->
...
<script type="text/javascript">
    ...
    //创建地图函数：
    function createMap(){
        var map = new BMap.Map("dituContent01");//在百度地图容器中创建一个地图
        var point = new BMap.Point(114.252294,22.716718);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"<?php echo ($name["content"]); ?>",content:"<?php echo ($office["content"]); ?>",point:"114.252294|22.716818",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
