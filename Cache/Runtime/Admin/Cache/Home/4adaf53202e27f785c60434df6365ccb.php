        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12" style="margin-bottom:10px;">
                    ...
                    <div style="float:right;"><a href="<?php echo U('News/add_en');?>" style="width:150px;"type="button" class="btn btn-primary">新 增 新 闻</a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <td>
                                        <div align="center">
                                            <div style="width:200px;">
                                                <a type="button" class="btn btn-success" href="<?php echo U('News/alter_en');?>?id=<?php echo ($data["id"]); ?>">修 改</a>
                                                <a type="button" class="btn btn-danger" href="<?php echo U('News/delete_en_handle');?>?id=<?php echo ($data["id"]); ?>">删 除</a>
                                            </div>
                                        </div>
                                    </td>
