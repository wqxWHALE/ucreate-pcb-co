    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">修改生产流程</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Support/alter_process_en_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <textarea name="content" style="width:100%;height:300px;visibility:hidden;"><?php echo ($process["content"]); ?></textarea>
            <br/>
