...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('About/index_en');?>">关于我们(英文)</a></li>
              <li class="active">修改关于我们</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('About/alter_en_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <textarea name="content" style="width:100%;height:300px;visibility:hidden;"><?php echo ($about["content"]); ?></textarea>
            <br/>
            <input name="id" value="<?php echo ($about["id"]); ?>" type="hidden">
