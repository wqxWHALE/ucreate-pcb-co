        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12" style="margin-bottom:10px;">
                    ...
                    <div style="float:right;"><a href="<?php echo U('Support/add_ability_en');?>" style="width:150px;"type="button" class="btn btn-primary">新 增 生 产 能 力</a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <td>
                                        <div align="center">
                                            <div style="width:200px;padding-top:5px;">
                                                <a href="<?php echo U('Support/alter_ability_en');?>?id=<?php echo ($data["id"]); ?>" type="button" class="btn btn-success">修 改</a>
                                                <a href="<?php echo U('Support/delete_ability_en_handle');?>?id=<?php echo ($data["id"]); ?>" type="button" class="btn btn-danger">删 除</a>
                                            </div>
                                        </div>
                                    </td>
