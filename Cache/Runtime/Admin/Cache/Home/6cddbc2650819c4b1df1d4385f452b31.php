                ...
                <div class="col-md-12">              
                    <table class="table table-bordered" style="border-bottom:1px solid #DDD;">
                      <tbody>
                        ...
                        <tr>
                          <td style="col-md-4">公司名(英文)：</td>
                          <td style="col-md-6"><?php echo ($name_en['content']); ?></td>
                          <td style="col-md-2"><a href="<?php echo U('Operation/alter_user');?>?id=<?php echo ($name_en['id']); ?>&name=公司名(英文)" type="submit" style="width:100%;" class="btn btn-success">修 改</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="col-md-4">办公室(英文)：</td>
                          <td style="col-md-6"><?php echo ($office_en['content']); ?></td>
                          <td style="col-md-2"><a href="<?php echo U('Operation/alter_user');?>?id=<?php echo ($office_en['id']); ?>&name=办公室(英文)" type="submit" style="width:100%;" class="btn btn-success">修 改</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="col-md-4">深圳工厂(英文)：</td>
                          <td style="col-md-6"><?php echo ($factory_shenzhen_en['content']); ?></td>
                          <td style="col-md-2"><a href="<?php echo U('Operation/alter_user');?>?id=<?php echo ($factory_shenzhen_en['id']); ?>&name=深圳工厂(英文)" type="submit" style="width:100%;" class="btn btn-success">修 改</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="col-md-4">惠州工厂(英文)：</td>
                          <td style="col-md-6"><?php echo ($factory_huizhou_en['content']); ?></td>
                          <td style="col-md-2"><a href="<?php echo U('Operation/alter_user');?>?id=<?php echo ($factory_huizhou_en['id']); ?>&name=惠州工厂(英文)" type="submit" style="width:100%;" class="btn btn-success">修 改</a></td>
                        </tr>      
                      </tbody>
                    </table>
                </div>
