...
<div id="page-wrapper" >
    ...
    <form class="form-signin" role="form" action="<?php echo U('Operation/alter_user_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  <td>内容:</td>
                  <td><textarea name="content" class="form-control" rows="1" placeholder="请输入内容"><?php echo ($data["content"]); ?></textarea></td>
                </tr>
              </tbody>
            </table>
