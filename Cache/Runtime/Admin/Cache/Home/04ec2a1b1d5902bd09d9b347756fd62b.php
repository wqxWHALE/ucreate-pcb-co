...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('Support/device_en');?>">技术支持(英文)</a></li>
              <li class="active">修改设备简介</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" role="form" action="<?php echo U('Support/alter_device_en_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>内容:</td>
                  <td><textarea name="content" class="form-control" rows="5" placeholder="请输入内容"><?php echo ($data["content"]); ?></textarea></td>
                </tr>
              </tbody>
            </table>
