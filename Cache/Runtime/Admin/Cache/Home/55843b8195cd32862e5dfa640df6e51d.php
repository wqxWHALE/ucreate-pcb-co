...
<head>
  ...
  <script type="text/javascript">
    ...
    {  
      $("li").click(function(){
          $('.sidebar-nav').children('li').attr('class','#');
    ...
    function callApplicationCount(){
      $.getJSON("<?php echo U('Index/getApplicationCount');?>", function (data, status, xhr) {
          if(data != "0")
          {
            var text = '<span class="label label-info" style="background-color:#C03111;">' + '+' + data + '</span>';
...
<!--     <ul id="quality-menu" class="nav nav-list collapse">
    ...
    <a href="<?php echo U('Contact/index');?>" class="nav-header">
      <i class="icon-comment"></i>联系我们
      <div id="callApplicationCount" style="float:right;" ></div>
    </a>
