...
<body class="">  
  ...
  <div class="sidebar-nav">
    ...
    <ul id="production-menu" class="nav nav-list collapse">
      <li ><a href="privacy-policy.html">硬板</a></li>
      <li ><a href="terms-and-conditions.html">软板</a></li>
      <li ><a href="terms-and-conditions.html">软硬结合板</a></li>
    </ul>
    ...
    <ul id="support-menu" class="nav nav-list collapse">
      <li ><a href="privacy-policy.html">设备展示</a></li>
      <li ><a href="terms-and-conditions.html">生成流程</a></li>
      <li ><a href="terms-and-conditions.html">生成能力</a></li>
    </ul>
    ...
    <a href="#recruit-menu" class="nav-header collapsed" data-toggle="collapse">
      <i class="icon-legal"></i>人才招聘
      <i class="icon-chevron-up" style="margin-top: 10px;"></i>
    </a>
    <ul id="recruit-menu" class="nav nav-list collapse">
      <li ><a href="privacy-policy.html">人才理念</a></li>
      <li ><a href="terms-and-conditions.html">酬薪福利</a></li>
    </ul>
