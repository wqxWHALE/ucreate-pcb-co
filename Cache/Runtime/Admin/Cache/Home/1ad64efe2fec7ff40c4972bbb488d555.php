...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb" style="margin-bottom:0px">
              <li><a href="<?php echo U('News/index_en');?>">新闻中心(英文)</a></li>
    ...
    <form class="form-signin" role="form" action="<?php echo U('News/alter_en_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  ...
                  <td><input name="title" type="text" class="form-control" style="width:320px;" placeholder="请输入文章标题" value="<?php echo ($data["title"]); ?>"></td>
                </tr>
                <tr>
                  <td>内容:</td>
                  <td>
                    <textarea name="content" style="width:100%;height:500px;visibility:hidden;"><?php echo ($data["content"]); ?></textarea>
                  </td>
                </tr>
              </tbody>
            </table>
