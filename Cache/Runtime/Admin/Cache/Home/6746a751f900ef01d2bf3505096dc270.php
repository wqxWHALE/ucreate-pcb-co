    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">修改图片介绍</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Culture/alter_picture_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>标题:</td>
                  <td><input name="title" type="text" class="form-control" style="width:250px" placeholder="请输入标题" value="<?php echo ($data["title"]); ?>"></td>
                </tr>
                <tr>
                  <td>当前图片:</td>
