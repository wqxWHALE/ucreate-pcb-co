    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">添加生产能力</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" role="form" action="<?php echo U('Support/add_ability_en_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>名称:</td>
                  <td><input name="title" class="form-control" style="width:400px;" placeholder="请输入名称" value="" type="text"></td>
                </tr>
                <tr>
                  <td>参数:</td>
                  <td><input name="parameter" class="form-control" style="width:100%;" placeholder="请输入参数" value="" type="text"></td>
                </tr>
                <tr>
                  <td>备注:</td>
                  <td><input name="remark" class="form-control" style="width:width:100%;" placeholder="请输入备注" value="" type="text"></td>
                </tr>
              </tbody>
            </table>
