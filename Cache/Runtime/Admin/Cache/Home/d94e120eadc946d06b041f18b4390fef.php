...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('Production/soft');?>">软板产品</a></li>
              <li class="active">添加软板产品</li>
            </ol>
        </div>
    </div>
    <form enctype="multipart/form-data" class="form-signin" role="form" action="<?php echo U('Production/add_soft_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>名称:</td>
                  <td><input name="name" class="form-control" style="width:320px;" placeholder="请输入名称" value="软板" type="text"></td>
                </tr>
                <tr>
                  <td>层数:</td>
