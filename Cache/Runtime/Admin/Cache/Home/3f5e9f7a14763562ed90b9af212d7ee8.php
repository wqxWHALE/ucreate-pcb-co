    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">添加软硬结合板产品</li>
            </ol>
        </div>
    </div>
    <form enctype="multipart/form-data" class="form-signin" role="form" action="<?php echo U('Production/add_mixture_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>名称:</td>
                  <td><input name="name" class="form-control" style="width:320px;" placeholder="请输入名称" value="软硬结合板" type="text"></td>
                </tr>
                <tr>
                  <td>层数:</td>
